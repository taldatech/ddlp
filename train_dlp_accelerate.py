"""
Main DLPv2 training function for multi-GPU machines.
        ...
        if epoch % eval_epoch_freq == 0 or epoch == num_epochs - 1:
            if accelerator.is_main_process:
                ...
                vutils.save_image(
                    ...
                    nrow=8, pad_value=1)
                accelerator.save(unwrapped_model.state_dict(), os.path.join(save_dir, f'{ds}_dlp{run_prefix}.pth'))
            ...
            if best_valid_loss > valid_loss:
                ...
                accelerator.save(unwrapped_model.state_dict(),
                                 os.path.join(save_dir, f'{ds}_dlp{run_prefix}_best.pth'))
